...
import CargoCultScienceTestEssay from "./CargoCultScienceTestEssay";
import NewDarkAgeAcademiaEssay from "./NewDarkAgeAcademiaEssay";
import TragedyCognitiveCommonsAcademicGamesEssay from "./TragedyCognitiveCommonsAcademicGamesEssay";
    ...
    <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 shadow-sm space-y-6 md:space-y-8 animate-fade-in" id="integrated-article-comp">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 xl:grid-cols-12 gap-2 bg-slate-50 p-1.5 rounded-xl border border-slate-200">
          ...
          <button
            onClick={() => setActiveArticle("expertsknowbetter")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "expertsknowbetter"
                ? "bg-amber-955 text-white shadow-sm animate-pulse"
                : "text-amber-900 hover:bg-amber-50 hover:text-amber-955"
            }`}
            id="toggle-article-expertsknowbetter"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-amber-550 animate-pulse" />
          ...
          <button
            onClick={() => setActiveArticle("papermillscopyright")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "papermillscopyright"
                ? "bg-amber-955 text-white shadow-sm animate-pulse"
                : "text-amber-900 hover:bg-amber-50 hover:text-amber-955"
            }`}
            id="toggle-article-papermillscopyright"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-amber-550 animate-pulse" />
          ...
          <button
            onClick={() => setActiveArticle("ninetyfivepercentgarbage")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "ninetyfivepercentgarbage"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-ninetyfivepercentgarbage"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
          ...
          <button
            onClick={() => setActiveArticle("genuineinnovation")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "genuineinnovation"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-genuineinnovation"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
            Essay CL: Beyond Conformity: Why Echo Chambers Murder Innovation
          </button>
          <button
            onClick={() => setActiveArticle("ecosystemdegradation")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "ecosystemdegradation"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-ecosystemdegradation"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
            Essay CM: Global Academic Collapse vs. Rebellious Breakthroughs
          </button>
          <button
            onClick={() => setActiveArticle("fieldsvsnobel")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "fieldsvsnobel"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-fieldsvsnobel"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
          ...
          <button
            onClick={() => setActiveArticle("scientificcorrectionandcargocult")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "scientificcorrectionandcargocult"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-scientificcorrectionandcargocult"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
          ...
          <button
            onClick={() => setActiveArticle("cargocultsciencetest")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "cargocultsciencetest"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-cargocultsciencetest"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
            Essay EA: When a Theory Is Overturned but Academia Carries On: The Cargo Cult Science Test
          </button>
          <button
            onClick={() => setActiveArticle("newdarkageacademia")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "newdarkageacademia"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-newdarkageacademia"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
            Essay EB: The New Dark Age of Academia: Why Modern Science Is Terminally Ill
          </button>
          <button
            onClick={() => setActiveArticle("tragedycognitivecommons")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "tragedycognitivecommons"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-tragedycognitivecommons"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
            Essay EC: The Hyper-Efficient Game of Unaccountable Science (Lovett 2026 Synthesis)
          </button>
          <button
            onClick={() => setActiveArticle("papermillscommercial")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "papermillscommercial"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-papermillscommercial"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
            Essay ED: Paper Mills as Legitimate Commercial Transactions & Cargo Cult Epistemology
          </button>
          <button
            onClick={() => setActiveArticle("reviewerselfcitation")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "reviewerselfcitation"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-reviewerselfcitation"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
            Essay EE: Reviewer Self-Citation Rights, Review Mills & Transparency Paradox
          </button>
          <button
            onClick={() => setActiveArticle("aiinstrumentinnovation")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "aiinstrumentinnovation"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-aiinstrumentinnovation"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
          ...
          <button
            onClick={() => setActiveArticle("tieronetierfourcargocult")}
            className={`flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-sans text-xs font-bold uppercase transition tracking-wider cursor-pointer ${
              activeArticle === "tieronetierfourcargocult"
                ? "bg-rose-955 text-white shadow-sm animate-pulse"
                : "text-rose-900 hover:bg-rose-50 hover:text-rose-955"
            }`}
            id="toggle-article-tieronetierfourcargocult"
          >
            <Sparkles className="w-4 h-4 shrink-0 text-rose-550 animate-pulse" />
      ...
      {activeArticle === "genuineinnovation" && (
        <GenuineInnovationVsEchoChambersEssay />
      )}

      {activeArticle === "ecosystemdegradation" && (
        <EcosystemDegradationEssay />
      )}
      ...
      {activeArticle === "cargocultsciencetest" && (
        <CargoCultScienceTestEssay />
      )}

      {activeArticle === "newdarkageacademia" && (
        <NewDarkAgeAcademiaEssay />
      )}

      {activeArticle === "tragedycognitivecommons" && (
        <TragedyCognitiveCommonsAcademicGamesEssay />
      )}

      {activeArticle === "papermillscommercial" && (
        <PaperMillsLegitimateCommercialTransactionsEssay />
      )}

      {activeArticle === "reviewerselfcitation" && (
        <ReviewerSelfCitationAndTransparencyParadoxEssay />
      )}
      ...
      <div className="mt-8 pt-8 border-t border-gray-150 space-y-4" id="substack-cta-block">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-2">
          ...
          >
            Reviewer Self-Citation Rights (SSRN 5524363) <Share2 className="w-3.5 h-3.5" />
          </a>
          <a
