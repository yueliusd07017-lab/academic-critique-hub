...
import { Brain, ShieldAlert, Zap, AlertTriangle, FileText, ExternalLink, CheckCircle2, Lock, Flame, Award, Globe, UserX, Lightbulb, Scale } from "lucide-react";
  ...
  return (
    <article className="prose max-w-none text-gray-800 leading-relaxed font-serif text-sm md:text-base space-y-6 animate-fade-in" id="newdarkageacademia-article-text">
      ...
      <div className="space-y-4 text-left">
        <h3 className="text-xl font-bold text-gray-955 font-sans tracking-tight flex items-center gap-2 text-rose-955 border-b border-gray-100 pb-1.5">
          <span className="text-rose-600 font-mono">II.</span> The Empirical Proof of Avoidance: Ignored Outreach & Cross-Discipline Fear
          <span className="text-xs font-sans text-gray-400 font-normal ml-auto">二、不可辩驳的回避证据：跨领域邮件石沉大海与不敢涉足是非之地</span>
        </h3>
        <p>
        ...
        <p>
          To bridge this artificial divide, Dr. Yue Liu conducted a massive direct email campaign—contacting thousands of microwave absorption specialists, <strong>materials science researchers outside microwave absorption</strong>, and <strong>leading physics professors worldwide</strong>, clearly presenting the published wave-mechanics proofs and inviting open debate.
        </p>
        <div className="p-4 bg-slate-900 text-slate-100 rounded-xl space-y-3 font-mono text-xs md:text-sm my-3 border border-slate-800">
          <div className="text-rose-400 font-bold uppercase text-xs flex items-center gap-2 border-b border-slate-800 pb-1.5">
            ...
            The Empirical Verdict of the Ignored Emails Across Disciplines:
          </div>
          <ul className="space-y-2 font-serif text-xs text-slate-300 leading-relaxed list-disc pl-5">
            <li>
              <strong>Massive Silence Across All Sectors:</strong> The near-total lack of email replies from thousands of academics—both inside and outside the microwave field—does not mean they failed to receive or understand the material. It proves that researchers <strong>actively refuse to touch a controversial truth</strong> (不敢涉足是非之地).
            </li>
            <li>
      ...
      {/* Section 3: Academic System Suppression & Tone Police Gatekeeping */}
      <div className="space-y-4 text-left">
        <h3 className="text-xl font-bold text-gray-955 font-sans tracking-tight flex items-center gap-2 text-rose-955 border-b border-gray-100 pb-1.5">
          <span className="text-rose-600 font-mono">III.</span> Academic System Gatekeeping: Demanding "Politeness" to Block Critical Truth
          <span className="text-xs font-sans text-gray-400 font-normal ml-auto">三、体制化压制：“礼貌套路”与拒不承认“95%是垃圾”</span>
        </h3>
        <p>
          The academic system actively prevents published critiques claiming "academia is practicing Cargo Cult Science and over 95% of SCI articles are garbage" from appearing in mainstream literature. When presented with rigorous manuscripts detailing the collapse of peer review (e.g., Y. Liu, <em>Preprints.org</em>, 2025, 10.20944/preprints202507.1953.v1), reviewers and editors resort to politeness gatekeeping and rhetorical evasion:
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-3 font-mono text-xs">
          <div className="p-4 bg-slate-900 text-slate-100 rounded-xl space-y-2 border border-slate-800">
            <div className="text-amber-400 font-bold font-sans flex items-center gap-1.5 border-b border-slate-800 pb-1">
              ...
              Qeios Review Critique 1 (DOI: 10.32388/5FRZHG)
            </div>
            <blockquote className="font-serif text-xs text-slate-300 italic border-l-2 border-amber-400 pl-2 my-1">
            ...
            <p className="text-slate-400 text-[11px] font-sans">
              • Mechanism: Using demands for "politeness" and decorum as a weapon to suppress explicit identification of disproven formulas.
            </p>
          </div>
          <div className="p-4 bg-slate-900 text-slate-100 rounded-xl space-y-2 border border-slate-800">
            <div className="text-amber-400 font-bold font-sans flex items-center gap-1.5 border-b border-slate-800 pb-1">
              <FileText className="w-4 h-4 text-amber-400 shrink-0" />
              Qeios Review Critique 2 (DOI: 10.32388/4PN4RT)
            </div>
            <blockquote className="font-serif text-xs text-slate-300 italic border-l-2 border-amber-400 pl-2 my-1">
              "I do not support the claim that 90% of journal articles are false... According to Nobel laureate Honjo Tasuku, 90% of the views published by top magazines like CNS are wrong. As I said before, I see this sentence as an exaggerated formulation to alert young researchers..."
            </blockquote>
            <p className="text-slate-400 text-[11px] font-sans">
              • Mechanism: Dismissing even Nobel laureate warnings as "exaggerated figures" to protect institutional prestige.
            </p>
          </div>
        </div>
      </div>

      {/* Section 4: Grassroots & Cross-Sector Verdicts — Elon Musk, Historian Li Bozhong */}
      <div className="space-y-4 text-left">
        <h3 className="text-xl font-bold text-gray-955 font-sans tracking-tight flex items-center gap-2 text-rose-955 border-b border-gray-100 pb-1.5">
          <span className="text-rose-600 font-mono">IV.</span> Grassroots & Cross-Sector Consensus: "95%+ of Research Papers Are Garbage"
          <span className="text-xs font-sans text-gray-400 font-normal ml-auto">四、草根阶层与跨界共识：95%以上的论文是有害学术垃圾</span>
        </h3>
        <p>
          While the academic establishment rejects the "95% garbage" thesis to protect its publication market, voices from grassroots whistleblowers, historians, and tech innovators confirm this reality:
        </p>
        <div className="space-y-3 font-serif text-xs md:text-sm my-3">
          <div className="p-4 bg-rose-50 border border-rose-200 rounded-xl space-y-1.5">
            <div className="font-bold text-rose-950 font-sans flex items-center gap-2">
              <UserX className="w-4 h-4 text-rose-700 shrink-0" />
              1. Grassroots Whistleblowers (Student Geng 耿同学)
            </div>
            <p className="text-slate-800 leading-relaxed">
              Exposed mountains of fabricated experimental data, duplicated images, and copy-pasted results across peer-reviewed SCI literature, providing overwhelming empirical proof that the journal system is producing Cargo Cult garbage.
            </p>
          </div>
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-1.5">
            <div className="font-bold text-slate-900 font-sans flex items-center gap-2">
              ...
              2. Historian Li Bozhong (李伯重, CASS) & The 2008 CPPCC Two Sessions
            </div>
            <p className="text-slate-800 leading-relaxed">
              Renowned historian Li Bozhong declared: <em>"Regardless of the form, 'academic garbage' is harmful, and it is a public hazard."</em> During the 2008 CPPCC "Two Sessions", education committee members explicitly lamented: <em>"Now 95% of scientific research papers are garbage."</em>
            </p>
          </div>
          <div className="p-4 bg-slate-900 text-slate-100 rounded-xl space-y-1.5 border border-slate-800 font-mono">
            <div className="font-bold text-amber-400 font-sans flex items-center gap-2">
              <Zap className="w-4 h-4 text-amber-400 shrink-0" />
              3. Tech Innovator Elon Musk
            </div>
      ...
      {/* Section 5: The Structural Tragedy — Theoretical Logic vs Surface Misconduct */}
      <div className="space-y-4 text-left">
        <h3 className="text-xl font-bold text-gray-955 font-sans tracking-tight flex items-center gap-2 text-rose-955 border-b border-gray-100 pb-1.5">
          <span className="text-rose-600 font-mono">V.</span> The Structural Tragedy: Why the Most Important Task Is Left Undone
          <span className="text-xs font-sans text-gray-400 font-normal ml-auto">五、结构性悲剧：最重要的理论逻辑甄别无人去 做</span>
        </h3>
        <p>
          This exposes a tragic institutional mismatch between academic capability and courage:
        </p>
        <div className="p-4 bg-slate-900 text-slate-100 rounded-xl space-y-3 font-mono text-xs md:text-sm my-3 border border-slate-800">
          <div className="text-rose-400 font-bold uppercase text-xs flex items-center gap-2 border-b border-slate-800 pb-1.5">
            <Scale className="w-4 h-4 text-rose-400 shrink-0" />
            Theoretical Logic Errors vs. Surface Image Misuse
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-serif text-xs">
            <div className="bg-slate-950 p-3 rounded border border-slate-800 space-y-1.5">
              <div className="font-bold text-amber-300 font-sans">Level A: Grassroots Whistleblowers</div>
              <p className="text-slate-300 leading-relaxed">
                Grassroots whistleblowers have the <strong>courage</strong> to expose image duplication and data fabrication, but <strong>lack the deep theoretical physics and mathematical training</strong> required to dismantle foundational paradigm fallacies (such as wave mechanics vs. impedance matching).
              </p>
            </div>
            <div className="bg-slate-950 p-3 rounded border border-slate-800 space-y-1.5">
              <div className="font-bold text-amber-300 font-sans">Level B: Academic Establishments</div>
              <p className="text-slate-300 leading-relaxed">
                Academic "experts" have the <strong>technical background</strong> to evaluate theoretical logic and first-principles derivations, but <strong>STRICTLY REFUSE TO DO SO</strong> out of career self-preservation, fear of losing grants, and protection of peer networks.
              </p>
            </div>
          </div>
          <p className="text-xs text-rose-300 font-sans pt-2 border-t border-slate-800">
            <strong>The Result:</strong> Evaluating whether papers are fundamentally wrong based on first-principles logical consistency (1+1=2) is far more important than catching image copy-pasting—yet because academics refuse and grassroots cannot, <strong>the most crucial task in science is completely abandoned!</strong> (Y. Liu & Y. Liu, <em>Redefining Review Articles: Beyond Balance Toward Theoretical Innovation</em>, SSRN 5434337).
          </p>
        </div>
      </div>

      {/* Section 6: Galileo in the Dark Ages — Refuting the "Good Scientists Still Exist" Myth */}
      <div className="space-y-4 text-left">
        <h3 className="text-xl font-bold text-gray-955 font-sans tracking-tight flex items-center gap-2 text-rose-955 border-b border-gray-100 pb-1.5">
          <span className="text-rose-600 font-mono">VI.</span> The Fallacy of Isolated Exception: "Galileo Existed, But the Middle Ages Were Still Dark"
          <span className="text-xs font-sans text-gray-400 font-normal ml-auto">六、驳斥“仍有人做真科学”套路：伽利略存在不等于中世纪不黑暗</span>
        </h3>
        <p>
      ...
      {/* Section 7: The Published Corpus on Academic Collapse */}
      <div className="space-y-4 text-left">
        <h3 className="text-xl font-bold text-gray-955 font-sans tracking-tight flex items-center gap-2 text-rose-955 border-b border-gray-100 pb-1.5">
          <span className="text-rose-600 font-mono">VII.</span> Key Reference Corpus: Treatises on Academic Degeneration
          <span className="text-xs font-sans text-gray-400 font-normal ml-auto">七、学术崩塌论著文献库</span>
        </h3>
        <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-2 font-mono text-xs text-slate-800 my-3">
          <ul className="space-y-1.5 text-xs font-serif leading-relaxed text-slate-700">
            ...
            <li>• <strong>Y. Liu & Y. Liu</strong>, <em>Redefining Review Articles: Beyond Balance Toward Theoretical Innovation</em>, SSRN: 5434337 / Substack (2025).</li>
            <li>• <strong>Y. Liu</strong>, <em>Why Are Research Findings Supported by Experimental Data with High Probability Often False?</em>, Preprints.org: 10.20944/preprints202507.1953.v1 (2025).</li>
      ...
      <div className="space-y-4 text-left pt-4 border-t border-gray-200">
        <h3 className="text-xl font-bold text-gray-955 font-sans tracking-tight flex items-center gap-2 text-rose-955 border-b border-gray-100 pb-1.5">
          <span className="text-rose-600 font-mono">VIII.</span> Conclusion: Modern Academia Is Terminally Ill
          <span className="text-xs font-sans text-gray-400 font-normal ml-auto">八、总结：现代科学界不可救药</span>
        </h3>
        <p>
